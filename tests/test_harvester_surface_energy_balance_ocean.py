...
def test_global_mean_values(tolerance=0.001):
    """The value of 16.89081142484145 is the mean value of the global means 
    ...
    global_mean = 16.89081142484145 
    for item in data1:
        if item.statistic == 'mean':
           print("mean ",item.value)  
